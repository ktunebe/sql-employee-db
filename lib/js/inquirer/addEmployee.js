...
const newEmployee = async () => {
    try {
        ...
        const foundRole = await pool.query(`SELECT id FROM roles WHERE title = $1;`, [newEmployeeRole])
        ...
        await pool.query(
            ...
            VALUES ($1, $2, $3, $4);`, [newEmployeeFirstName, newEmployeeLastName, roleId, managerId]
        )
